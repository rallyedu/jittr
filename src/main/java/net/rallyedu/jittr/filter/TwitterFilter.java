package net.rallyedu.jittr.filter;
...
import static net.rallyedu.jittr.TwitterUtils.getAccessToken;
import static net.rallyedu.jittr.TwitterUtils.setTwitter;
...
public class TwitterFilter implements Filter {
            ...
            ServletException
    {
        ...
        Twitter twitter = TwitterFactory.getInstance().getTwitter(accessToken);
